...
# <a id=e8c60/>Installation and Setup


## <a id=f8aeb/>1. Download the Source
...
## <a id=28153/>2. Set up Python *Virtual Environment*
...
## <a id=c4055/>3. Install Required Python Modules
...
## <a id=d4298/>4. Configure Signbank
...
## <a id=7e9cd/>5. Setting Up the Database
...
## <a id=89aa6/>6. Create Admin User
...
## <a id=2c01d/>Django Admin Pages (Static Files)
...
## <a id=f68de/>Django Admin Doc Pages (`docutils`)
...
## <a id=e9cb4/>List Django Subcommands
...
## <a id=b278e/>Port number in `ALLOWED_HOSTS`
...
## <a id=e0229/>`makemigrations` fail (‘cannot import name 'ugettext_lazy'’)
